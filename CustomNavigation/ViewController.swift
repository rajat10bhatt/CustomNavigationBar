...
class ViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        initializeAdminButtonNavigationBar(titleString: "Rajat Bhatt", isLeftBarButtonHidden: false, isRightBarButtonHidden: true)
    }
    
    /// Set navigation bar with Admin Button
    func initializeAdminButtonNavigationBar(titleString: String, isLeftBarButtonHidden: Bool, isRightBarButtonHidden: Bool) {
